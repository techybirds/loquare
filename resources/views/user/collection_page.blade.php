...
<div class="collection_page_<?php echo $page; ?>">
    <div class="collection" data-id="<?php echo $collection->id; ?>"; id="collection_<?php echo $collection->id; ?>" style="display: none;">
        <div class="collection__left">
            <div class="collection__img lazyload" data-sizes="auto" data-bgset="{{ url('/storage/Property/'.$collection->id.'/thumbs/'.$collection->filename) }} 1x, {{ url('/storage/Property/'.$collection->id.'/thumbs/'.$collection->filename) }} 2x"  style='background-image: url({{ asset("/frontend/images/thumb-loquare.png") }});'></div>
        </div>
        <div class="collection__center">
            <a href="{{ url('/rent/property/'.$collection->id)  }}" class="collection__title"><?php echo $collection->direccion; ?></a>
