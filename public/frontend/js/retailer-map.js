...
function FetchInfo(property)
{
    ...
    block += '<li>'+property.rooms+' <img src="'+basepath+'/frontend/assets/icons/room.png" /></li>';
    block += '<li>'+property.bathrooms+' <img src="'+basepath+'/frontend/assets/icons/bath.png" /></li>';
    block += '</ul>';
    block += '</div>';
